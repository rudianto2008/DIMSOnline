...
using Administration = DIMSOnline.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: DIMSOnline.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
