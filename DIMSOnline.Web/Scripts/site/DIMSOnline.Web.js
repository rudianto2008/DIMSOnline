...
(function (DIMSOnline) {
    ...
    })(BasicSamples = DIMSOnline.BasicSamples || (DIMSOnline.BasicSamples = {}));
})(DIMSOnline || (DIMSOnline = {}));
var DIMSOnline;
(function (DIMSOnline) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = DIMSOnline.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = DIMSOnline.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = DIMSOnline.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (DIMSOnline) {
    ...
    })(Northwind = DIMSOnline.Northwind || (DIMSOnline.Northwind = {}));
})(DIMSOnline || (DIMSOnline = {}));
var DIMSOnline;
(function (DIMSOnline) {
    var Northwind;
...
(function (DIMSOnline) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'DIMSOnline.Northwind.Gender', 'DIMSOnline.Northwind.Entities.Gender');
    })(Northwind = DIMSOnline.Northwind || (DIMSOnline.Northwind = {}));
})(DIMSOnline || (DIMSOnline = {}));
var DIMSOnline;
(function (DIMSOnline) {
...
(function (DIMSOnline) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'DIMSOnline.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = DIMSOnline.Northwind || (DIMSOnline.Northwind = {}));
})(DIMSOnline || (DIMSOnline = {}));
var DIMSOnline;
(function (DIMSOnline) {
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        }(DIMSOnline.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(DIMSOnline.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(DIMSOnline.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        }(DIMSOnline.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        DIMSOnline.Common.ReportHelper.execute({
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: DIMSOnline.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: DIMSOnline.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new DIMSOnline.Northwind.OrderDialog();
                        ...
                        var chai = DIMSOnline.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = DIMSOnline.Northwind.EmployeeRow.getLookup().items
        ...
        }(DIMSOnline.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(DIMSOnline.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        }(DIMSOnline.Northwind.OrderDialog));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    DIMSOnline.Northwind.CategoryService.Retrieve({
        ...
        }(DIMSOnline.Northwind.CategoryDialog));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        }(DIMSOnline.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(DIMSOnline.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new DIMSOnline.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                DIMSOnline.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(DIMSOnline.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    DIMSOnline.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(DIMSOnline.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(DIMSOnline.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    DIMSOnline.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return DIMSOnline.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return DIMSOnline.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return DIMSOnline.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return DIMSOnline.LanguageList.getValue();
            };
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        }(DIMSOnline.Northwind.SupplierDialog));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(DIMSOnline.Northwind.SupplierGrid));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return DIMSOnline.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return DIMSOnline.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return DIMSOnline.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return DIMSOnline.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                DIMSOnline.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    DIMSOnline.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(DIMSOnline.Northwind.CustomerDialog));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        }(DIMSOnline.Northwind.CustomerGrid));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = DIMSOnline.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(DIMSOnline.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return DIMSOnline.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new DIMSOnline.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(DIMSOnline.Northwind.OrderDetailDialog));
...
(function (DIMSOnline) {
    ...
    (function (Northwind) {
        ...
        }(DIMSOnline.Common.GridEditorBase));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        }(DIMSOnline.Northwind.OrderDetailsEditor));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return DIMSOnline.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return DIMSOnline.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return DIMSOnline.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return DIMSOnline.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        ...
        }(DIMSOnline.Common.BulkServiceAction));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return DIMSOnline.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return DIMSOnline.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return DIMSOnline.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(DIMSOnline.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new DIMSOnline.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new DIMSOnline.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new DIMSOnline.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (DIMSOnline) {
    ...
    DIMSOnline.SelectableEntityGrid = SelectableEntityGrid;
})(DIMSOnline || (DIMSOnline = {}));
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return DIMSOnline.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return DIMSOnline.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return DIMSOnline.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(DIMSOnline.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = DIMSOnline.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            DIMSOnline.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return DIMSOnline.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return DIMSOnline.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return DIMSOnline.Northwind.ProductService.baseUrl; };
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return DIMSOnline.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return DIMSOnline.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return DIMSOnline.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return DIMSOnline.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (DIMSOnline) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return DIMSOnline.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return DIMSOnline.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return DIMSOnline.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: DIMSOnline.Authorization.userDefinition.DisplayName,
